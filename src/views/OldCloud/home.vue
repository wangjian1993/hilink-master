	...
	<div class="app">
		...
		<div class="cloud-content" v-if="!isLoaded">
			<div class="search-box">
				<router-link to="/old/search" class="search">
			...
			<div class="options">
				...
				<router-link tag="div" to="/old/rank" class="option_item">
			...
			<div class="title">
				...
				<router-link tag="div" to="/old/differentAge">
					更多
...
import musicList from '../../components/old/musicList.vue';
const List = () => import('@/components/old/list');
const videoList = () => import('@/components/old/videoList');
export default {
	data() {
		return {
			bannerData: [], //轮播图
	...
	methods: {
		...
		//宝宝哄睡
		goSleepZone() {
			this.$router.push({ name: 'OldAlbumList', query: { name: '宝宝哄睡' } });
		},
		//历史记录
		goHistory() {
		...
		//跳转听儿歌页
		goListen(type) {
			this.$router.push({ name: 'OldSsec', query: { type: type } });
			console.log(type);
