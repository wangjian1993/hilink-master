...
export default {
	...
	methods: {
		...
		//进入详情页
		goDetail(item) {
			this.$router.push({ name: 'OldAlbumDetail', query: { id: item } });
		},
		//热门搜索
		hotSearch(val) {
			this.serchValue = val;
...
@import url('../../assets/css/old/common.less');
@import url('../../assets/css/old/search.less');
</style>
